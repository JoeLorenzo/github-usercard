...
axios.get(' https://api.github.com/users/JoeLorenzo')
  ...
  // divTag.classList('card')
  // imgElement.appendChild('divTag')
  // divTag.appendChild('cardsClass')
  // }
  // userCardCreater(user)
